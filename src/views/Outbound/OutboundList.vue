  ...
  <div class="outbound-list">
    ...
    <div class="main-table">
      <div class="row q-pt-md">
        <q-btn color="primary" :label="t('新建')" icon="add" class="q-mr-sm" flat @click="handleCreate" />
        <q-btn color="primary" class="q-mr-sm" :label="t('导入')" icon="file_upload" flat @click="handleImport" />
        ...
        >
          ...
          <template v-slot:body="props">
              ...
              <q-td colspan="8" class="order-info q-pa-none">
                <div class="row items-center justify-between">
                  <div class="order-basic-info">
                    ...
                    <span class="q-mr-md hover-copy" @click="$copy(props.row.packages?.[0]?.package_number)">
                      {{ t('包裹号') }}：{{ props.row.packages?.[0]?.package_number || '--' }}
                    </span>
                  </div>
            ...
            <q-tr :props="props" class="order-detail">
              ...
              <q-td>
                <div class="recipient-info flex-c-start-start gap-6">
                  <div class="text-weight-medium">{{ props.row.recipient?.fullname }}</div>
                  <div class="text-grey-7">{{ props.row.recipient?.phone }}</div>
                  <div class="text-grey-7 text-overflow-2">
                    {{
                      [
